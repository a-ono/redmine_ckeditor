...
* Redmine 3.0.x, (version {1.1.0.beta}[https://github.com/a-ono/redmine_ckeditor/tree/redmine3.0.x])

* Redmine 2.3.x, Ruby 1.9.2 or higher (version {1.0.20}[https://github.com/a-ono/redmine_ckeditor/tree/1.0.20])
...
You can configure {CKEditor settings}[http://docs.ckeditor.com/#!/api/CKEDITOR.config] by using the config/ckeditor.yml file.
