  ...
  class << self
    ...
    def allowed_tags
      @allowed_tags ||= %w[
        ...
        div dt em h1 h2 h3 h4 h5 h6 hr i img ins kbd li ol p pre samp small source span
        strike s strong sub sup table tbody td tfoot th thead tr tt u ul var video iframe
      ]
    end

    def allowed_attributes
      @allowed_attributes ||= %w[
        href src width height alt cite controls datetime title class name xml:lang abbr dir
